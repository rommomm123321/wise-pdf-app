...
export default function LoginPage() {
  ...
  const handleCustomClick = () => {
    ...
    const clickable = googleBtnRef.current?.querySelector('div[role="button"], div[tabindex="0"]') as HTMLElement;
  ...
  return (
    <Box sx={{
      ...
      <Box textAlign="center" mb={5}>
        <img src="https://wise-bim.com/logo-short.png" alt="WISE" style={{ height: 100, marginBottom: 16 }} />
        ...
        <Box sx={{ px: 4, py: 4 }}>
          {clientId ? (
            <GoogleOAuthProvider clientId={clientId}>
              <Box sx={{ position: 'relative' }}>
                ...
                >
                  <GoogleLogin
                    ...
                    onError={() => { setAuthError('Google login failed'); setLoading(false); }}
                    useOneTap
                    theme="filled_black"
                    shape="rectangular"
                    text="continue_with"
                ...
                <Box
                  ...
                  sx={{
                    ...
                    '&:hover': loading ? {} : { bgcolor: '#2a2a2a', borderColor: '#444' },
                    outline: 'none',
                  }}
                >
                  {loading
              ...
              {authError && (
                <Typography variant="caption" sx={{ color: '#f44', textAlign: 'center', display: 'block', mt: 2 }}>
                  {authError}
                </Typography>
              )}
            </GoogleOAuthProvider>
