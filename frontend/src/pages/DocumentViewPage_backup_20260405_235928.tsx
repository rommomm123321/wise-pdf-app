...
const DocumentViewPage = memo(() => {
  ...
  const [canvasMentionData, setCanvasMentionData] = useState<{ anchor: HTMLElement; query: string; onSelect: (name: string) => void; cursorPos?: { top: number; left: number } } | null>(null);
