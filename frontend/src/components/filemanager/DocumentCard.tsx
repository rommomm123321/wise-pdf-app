      ...
      >
        <CardContent
          sx={{
            ...
            pt: 1.5,
            pr: 4.5,
            pl: selectionMode || isSelected ? 4.5 : 1.5,
          }}
        >
          <Box sx={{ display: "flex", alignItems: "flex-start", gap: 1.5 }}>
            <PictureAsPdfIcon
              color="error"
              sx={{ fontSize: 40, mt: 0.5, flexShrink: 0 }}
            />
      ...
      >
        {canDownload && (
          <MenuItem
            onClick={() => {
              setAnchorEl(null);
              fetch(`/api/documents/${document.id}/proxy`, {
        ...
        {canDownload && onExportWithMarkups && (
          <MenuItem
            onClick={() => {
              setAnchorEl(null);
              onExportWithMarkups(document.id, document.name);
            }}
          >
        ...
        <MenuItem
          onClick={() => {
            setAnchorEl(null);
            onShowVersions?.(document.id, document.name);
          }}
        >
        ...
        {canManage && onShare && (
          <MenuItem
            onClick={() => {
              setAnchorEl(null);
              onShare(document.id, document.name);
            }}
          >
